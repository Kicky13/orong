...
<!--   Core JS Files   -->
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/jquery-3.1.1.min.js "
...
<!--  Charts Plugin -->
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/flot/jquery.flot.js "></script>
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/flot/jquery.flot.resize.js "></script>
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/flot/jquery.flot.pie.js "></script>
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/flot/jquery.flot.stack.js "></script>
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/flot/jquery.flot.categories.js "></script>
<script src="<?php echo base_url() . 'assets/'; ?>dashboard/vendors/charts/chartjs/Chart.min.js " type="text/javascript "></script>
