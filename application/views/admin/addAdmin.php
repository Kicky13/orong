                            ...
                            <form method="post" action="<?php echo base_url('index.php/admin/tambah'); ?>" class="form-horizontal">
                                ...
                                <div class="card-content">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input required name="nama" type="text" class="form-control" placeholder="Masukkan Nama">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="dropdown">
                                                <select required id="jabatan" name="jabatan" class="dropdown-toggle btn btn-primary btn-round btn-block">
                                                    <option selected disabled class="dropdown-item">Pilih Jabatan</option>
                                                    <option value="1" class="dropdown-item">Admin</option>
                                                    <option value="2" class="dropdown-item">Pelatih</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input required name="alamat" type="text" class="form-control" placeholder="Masukkan Alamat Anda">
                                        </div>
                                    </div>
                                    <div class="form-group row">
