                            ...
                            <form method="post" action="<?php echo base_url('index.php/angkatan/sunting'); ?>" class="form-horizontal">
                                ...
                                <div class="card-content">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input required type="text" name="nama" value="<?php echo $angkatan['nama_angkatan']; ?>" class="form-control" placeholder="Masukkan Nama Angkatan">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <?php foreach ($posisi as $value){ ?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input required type="text" name="jumlah<?php echo $value['id_posisi']; ?>" value="<?php echo $value['jumlah_require']; ?>" class="form-control" placeholder="Masukkan Jumlah <?php echo $value['nama_posisi']; ?> yang Dibutuhkan">
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
